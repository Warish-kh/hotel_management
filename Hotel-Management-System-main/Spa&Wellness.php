      ...
      <div class="container">
        ...
        <ul class="header-top-list">
          ...
          <li class="header-top-item">
            ...
            <a href="tel:01234567895" class="item-link">7700044104/7208746074</a>
          </li>
    ...
    <article>
      ...
      <section class="section hero has-before has-bg-image" id="home" aria-label="home"
        ...
        <div class="container">
          ...
          <h1 class="h1 hero-title">SPA
            INDULGENCES</h1>

          <p class="hero-text">

            Specially tailored luxury spa treatments at The Tissot-Hotel Palace, Mumbai, suited to your exclusive needs
            -
            as many treatments as you like, for as many hours or days as you like.
          </p>
          ...
          <ul class="grid-list">
            ...
            <li>
              <div class="service-card">
                ...
                <h3 class="h3">
                  <a href="#" class="card-title">OUTDOOR POOL
                  </a>
                </h3>
                ...
                <p class="card-text">
                  ...
                  For relaxation and rejuvenation alike, the outdoor swimming pool is an ideal locale to spend some time
                  hidden away from the bustle
                </p>
            ...
            <li>
              <div class="gallery-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">SPA & WELLNESS
                    </h3>

                  <p class="card-text">Steam Bath</p>
            ...
            <li>
              <div class="gallery-card">
                ...
                <div class="card-content">
                  ...
                  <h3 class="h3 card-title">SPA & WELLNESS</h3>

                  <p class="card-text">Facial Masseage</p>
            ...
            <li>
              <div class="gallery-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-text">Female Body Masseage</p>
            ...
            <li>
              <div class="gallery-card">
                ...
                <div class="card-content">
                  ...
                  <p class="card-text"> Male Body Masseage</p>
        ...
        <div class="container">
          ...
          <div class="appoin-card">
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img src="./assets/images/Screenshot 2024-10-04 152202.png" width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
            ...
            <figure class="card-banner img-holder" style="--width: 250; --height: 774;">
              <img src="./assets/images/Screenshot 2024-10-04 151721.png" width="250" height="774" loading="lazy" alt=""
                class="img-cover">
            </figure>
  ...
  <footer class="footer has-bg-image" style="background-image: url('./assets/images/footer-bg.png')">
    <div class="container">
              ...
              <div class="blog-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-date">
                    ...
                    <time datetime="2024-09-25">25 October 2024</time>
                  </div>
                </div>
          ...
          <ul class="footer-list">
            ...
            <li class="footer-list-item">
              ...
              <address class="contact-link">
                18, Saboo Siddik, MHSSCOE, Mumbai
              </address>
            </li>
            ...
            <li class="footer-list-item">
              ...
              <a href="tel:+0123456789" class="contact-link">+91 7208746074</a>
            </li>
      ...
      <div class="footer-bottom">
        <p class="copyright">
          &copy; 2024 <a href="#" class="copyright-link">Tissot Hotel</a>. All Rights Reserved.
        </p>
      </div>
