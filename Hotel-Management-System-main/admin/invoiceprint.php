...
<body>
	...
	$type_of_room = 0;
	if ($troom == "Luxury Room") {
		$type_of_room = 320;
	} else if ($troom == "Basic Room") {
		$type_of_room = 220;
	} else if ($troom == "Delux Room") {
		$type_of_room = 180;
	} else if ($troom == "Family Suits") {
		$type_of_room = 150;
	}
	...
	// $type_of_meal = isset($row['type_of_meal']) ? $row['type_of_meal'] : 0; // Default to 0 if undefined
	...
	<aside>
		...
		<div>
			<p align="center">Email :- Armanshaihk9899@gmail.com || Web :- www.tissot.com || Phone :- +91 72087460874 </p>
		</div>
	</aside>
