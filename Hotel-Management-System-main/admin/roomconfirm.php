...
if($stat == "NotConfirm")
{
    ...
    if($result){
        ...
        else if($RoomType=="Basic Room")
        {
            $type_of_room = 2000;
        }
        else if($RoomType=="Delux Room")
        {
            $type_of_room = 1500;
        }
        else if($RoomType=="Family Suits")
        {
            $type_of_room = 1000;
        }
        ...
        $ttot = (int)$type_of_room * (int)$noofday * (int)$NoofRoom;
        $mepr = (int)$type_of_meal * (int)$noofday;
        $btot = (int)$type_of_bed * (int)$noofday;
